...
namespace ChatClient.ServiceChat
{
    ...
    public interface IServiceChat
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IServiceChat/PlayHangman", ReplyAction = "http://tempuri.org/IServiceChat/PlayHangmanResponse")]
        void PlayHangman();

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IServiceChat/PlayHangman", ReplyAction = "http://tempuri.org/IServiceChat/PlayHangmanResponse")]
        System.Threading.Tasks.Task PlayHangmanAsync();
    }
    ...
    public partial class ServiceChatClient : System.ServiceModel.DuplexClientBase<ChatClient.ServiceChat.IServiceChat>, ChatClient.ServiceChat.IServiceChat
    {
        ...
        {
            base.Channel.PlayHangman();
        }

        public System.Threading.Tasks.Task PlayHangmanAsync()
        {
            return base.Channel.PlayHangmanAsync();
        }
    }
}